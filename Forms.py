...
class CreateProductForm(Form):
    ...
    stock_count = IntegerField('Stock Count', [validators.NumberRange(min=1, max=2218), validators.DataRequired()])
    price = IntegerField('Price', [validators.NumberRange(min=1, max= None), validators.DataRequired()])
